...
// 退休老師名單
$sql = "SELECT * FROM Teacher WHERE position LIKE '%退休%'";
...
<head>
  <meta charset="UTF-8">
  <title>退休教師資訊 - 資訊工程學系 系所成員系統<</title>
  <link rel="stylesheet" href="retired_style.css">
</head>
<body>
  ...
  <div class="layout">
    <aside class="sidebar">
      <ul>
        ...
        <li><a href="retired.php" class="active">退休教師</a></li>
      </ul>
    </aside>
<main class="content">
  ...
  <div class="teacher-card">
      ...
      <div class="info">
      <h3>
        <a href="teacherinfo.php?teacher_id=<?= urlencode($row['teacher_id']) ?>&from=retired.php" style="color:inherit;text-decoration:underline;">
        <?= htmlspecialchars($row['name']) ?>
          ...
          <?php
            ...
            if (!empty($exp_list)) {
                echo '<p><strong>研究專長：</strong>' . htmlspecialchars(implode('、', $exp_list)) . '</p>';
            }
          ?>
        </div>
  </div>
