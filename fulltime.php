...
// 只查詢職稱有「教授」或「講座」且沒有「兼任」的老師
$sql = "SELECT * FROM Teacher WHERE (position LIKE '%教授%' OR position LIKE '%何宜武先生%') AND position NOT LIKE '%兼任%' AND position NOT LIKE '%退休%'";
...
<head>
    <meta charset="UTF-8">
    <title>專任教師資訊 - 資訊工程學系 系所成員系統</title>
    <link rel="stylesheet" href="fulltime_style.css">
</head>
<body>
...
<div class="layout">
  <aside class="sidebar">
    <ul>
      ...
      <li><a href="fulltime.php" class="active">專任教師</a></li>
    ...
    <?php if (mysqli_num_rows($result) > 0): ?>
      <?php while ($row = mysqli_fetch_assoc($result)): ?>
        <div class="teacher-card">
          ...
          <div class="info">
            <h3>
              <a href="teacherinfo.php?teacher_id=<?= urlencode($row['teacher_id']) ?>&from=fulltime.php" style="color:inherit;text-decoration:underline;">
