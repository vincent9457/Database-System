...
// 只查詢職稱為「特聘教授」的老師
$sql = "SELECT * FROM Teacher WHERE position = '特聘教授'";
...
<head>
    <meta charset="UTF-8">
    <title>特聘教授資訊 - 資訊工程學系 系所成員系統</title>
    <link rel="stylesheet" href="special_prof_style.css">
</head>
<body>
...
<header>
    ...
    <span>›</span>
    <a href="special_prof.php">特聘教授資訊</a>
    </div>
...
<div class="layout">
  <aside class="sidebar">
    <ul>
      ...
      <li><a href="special_prof.php" class="active">特聘教授</a></li>
...
<main class="content">
  <?php if (mysqli_num_rows($result) > 0): ?>
    <?php while ($row = mysqli_fetch_assoc($result)): ?>
          ...
          <div class="info">
            <h3>
              <a href="teacherinfo.php?teacher_id=<?= urlencode($row['teacher_id']) ?>&from=special_prof.php" style="color:inherit;text-decoration:underline;">
