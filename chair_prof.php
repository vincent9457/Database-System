...
// 只查詢張真誠與桑慧敏的資料
$sql = "SELECT * FROM Teacher WHERE position LIKE '%講座%' AND position NOT LIKE '%特約講座%' AND position NOT LIKE '%榮譽特聘講座%' AND position NOT LIKE '%退休%'";
...
<head>
    <meta charset="UTF-8">
    <title>講座教授資訊 - 資訊工程學系 系所成員系統</title>
    <link rel="stylesheet" href="chair_prof_style.css">
...
<header>
    ...
    <span>›</span>
    <a href="chair_prof.php">講座教授資訊</a>
    </div>
...
<div class="layout">
  <aside class="sidebar">
    <ul>
      ...
      <li><a href="chair_prof.php" class="active">講座教授</a></li>
...
<main class="content">
    <?php if (mysqli_num_rows($result) > 0): ?>
        <?php while ($row = mysqli_fetch_assoc($result)): ?>
          ...
          <div class="info">
                    <h3>
                      <a href="teacherinfo.php?teacher_id=<?= urlencode($row['teacher_id']) ?>&from=chair_prof.php" style="color:inherit;text-decoration:underline;">
