...
// 只查詢職稱包含「兼任」的老師
$sql = "SELECT * FROM Teacher WHERE position LIKE '%兼任%'";
...
<head>
    <meta charset="UTF-8">
    <title>兼任教師資訊 - 資訊工程學系 系所成員系統</title>
    <link rel="stylesheet" href="part_time_style.css">
</head>
<body>
...
<div class="layout">
  <aside class="sidebar">
    <ul>
      ...
      <li><a href="part_time.php"  class="active">兼任教師</a></li>
...
<main class="content">
    <?php if (mysqli_num_rows($result) > 0): ?>
        <?php while ($row = mysqli_fetch_assoc($result)): ?>
                ...
                <div class="info">
                <h3>
                  <a href="teacherinfo.php?teacher_id=<?= urlencode($row['teacher_id']) ?>&from=part_time.php" style="color:inherit;text-decoration:underline;">
