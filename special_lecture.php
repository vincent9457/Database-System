...
// 查詢職稱為「特約講座」的老師
$sql = "SELECT * FROM Teacher WHERE position = '特約講座'";
...
<head>
  <meta charset="UTF-8">
  <title>特約講座資訊 - 資訊工程學系 系所成員系統</title>
  <link rel="stylesheet" href="special_lecture_style.css">
</head>
<body>
...
<header>
  <h1>逢甲大學 資訊工程學系 系所成員</h1>
    ...
    <span>›</span>
    <a href="special_lecture.php">特約講座資訊</a>
    </div>
  ...
  <aside class="sidebar">
    <ul>
      ...
      <li><a href="special_lecture.php" class="active">特約講座</a></li>
...
<main class="content">
  <?php if (mysqli_num_rows($result) > 0): ?>
    <?php while ($row = mysqli_fetch_assoc($result)): ?>
          ...
          <div class="info">
            <h3>
              <a href="teacherinfo.php?teacher_id=<?= urlencode($row['teacher_id']) ?>&from=special_lecture.php" style="color:inherit;text-decoration:underline;">
